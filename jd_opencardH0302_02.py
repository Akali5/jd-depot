...
"""
File: jd_opencardH0302_02.py(3.2-3.8 诠饰你的每一面2)
Author: HarbourJ
Date: 2023/3/2 19:00
TG: https://t.me/HarbourToulu
cron: 0 0 */3 2-8 3 *
new Env('3.2-3.8 诠饰你的每一面2');
ActivityEntry: https://lzdz1-isv.isvjcloud.com/m/1000411104/dz07de7ff45aa441faade1ff063f1c
Description: 开卡5 邀请10
            并发变量: export jd_opencard030201_uuid="你的助力码"
"""
...
inviterUuid = os.environ.get("jd_opencard030201_uuid") if os.environ.get("jd_opencard030201_uuid") else ""

venderId = "1000411104"
activityId = "dz07de7ff45aa441faade1ff063f1c"
activity_url = f"https://lzdz1-isv.isvjcloud.com/m/1000411104/8487146/{activityId}/?shareUuid={inviterUuid}&adsource=null"
print(f"【🛳活动入口】https://lzdz1-isv.isvjcloud.com/m/1000411104/8487146/{activityId}")
...
def activityContent(pin, pinImg, nickname):
    url = "https://lzdz1-isv.isvjcloud.com/dingzhi/jan/unionSecond/activityContent"
    try:
...
def initOpenCard(pin, actorUuid, shareUuid):
    url = "https://lzdz1-isv.isvjcloud.com/dingzhi/jan/unionSecond/initOpenCard"
...
def saveTask(actorUuid, shareUuid, pin, taskType, taskValue):
    url = "https://lzdz1-isv.isvjcloud.com/dingzhi/jan/unionSecond/saveTask"
...
if __name__ == '__main__':
    ...
    for cookie in cks[:]:
        ...
        if num == 1:
            ...
            shareUuid = actorUuid
            activityUrl = f"https://lzdz1-isv.isvjcloud.com/m/1000411104/8487146/{activityId}/?shareUuid={shareUuid}&adsource=null"
