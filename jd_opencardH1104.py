...
"""
File: jd_opencardH1104.py(雀巢咖啡邀请有礼)
Author: HarbourJ
...
cron: 1 1 1 1 1 1
new Env('雀巢咖啡邀请有礼');
ActivityEntry: https://lzkj-isv.isvjcloud.com/prod/cc/interactsaas/index?activityType=10006&activityId=1588413362149175298&shareUserId=1592411016902389761&templateId=20201228083300yqrhyl011&nodeId=101001005&prd=null&sid=c77e8b335974724742827d7c42f951cw&un_area=15_1213_71706_71728
Description: 邀请20人 300豆,自动助力,自动领奖,‼️该活动有且仅能领取一次奖励,默认领300豆🎁,或者手动领取
"""
...
activityId = "1588413362149175298"
shopId = "1000278417"
templateId = "20201228083300yqrhyl011"
share_userId = "1592411016902389761"
        ...
        if num == 1:
            ...
            if joinCodeInfo['joinDes'] != '不是会员无法参加':
                ...
                try:
                    ...
                    print("‼️该活动有且仅能领取一次奖励,默认自动领300豆🎁,或者手动领取")
                except:
