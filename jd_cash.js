...
!(async () => {
  ...
  await requireConfig()
  $.authorCode = await getAuthorShareCode('https://raw.githubusercontent.com/222222/===28===/master/shareCodes/===27===')
  if (!$.authorCode) {
    $.http.get({url: 'https://purge.jsdelivr.net/gh/222222/===28===@master/shareCodes/===27==='}).then((resp) => {}).catch((e) => $.log('刷新CDN异常', e));
    await $.wait(1000)
    $.authorCode = await getAuthorShareCode('https://cdn.jsdelivr.net/gh/222222/===28===@master/shareCodes/===27===') || []
  }
