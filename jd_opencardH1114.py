...
"""
File: jd_opencardH1114.py(Origins悦木之源邀请有礼)
Author: HarbourJ
Date: 2022/11/14 18:00
TG: https://t.me/HarbourToulu
TgChat: https://t.me/HarbourChat
cron: 1 1 1 1 1 1
new Env('Origins悦木之源邀请有礼');
ActivityEntry: https://lzkj-isv.isvjcloud.com/prod/cc/interactsaas/index?activityType=10006&activityId=1591976352508121089&shareUserId=1593144909601308674&templateId=20201228083300yqrhyl011&nodeId=101001005&prd=null&sid=c77e8b335974724742827d7c42f951cw&un_area=15_1213_71706_71728
Description: 邀请18人 200豆,自动助力,自动领奖,‼️该活动有且仅能领取一次奖励,默认领200豆🎁,或者手动领取
"""
...
activityId = "1591976352508121089"
shopId = "1000376284"
templateId = "20201228083300yqrhyl011"
share_userId = "1593222674747940866"
        ...
        if num == 1:
            ...
            if joinCodeInfo['joinDes'] != '不是会员无法参加':
                ...
                try:
                    ...
                    print("‼️该活动有且仅能领取一次奖励,默认自动领200豆🎁,或者手动领取")
                except:
                ...
                if prizeListRecord == []:
                    print('⚠️无奖品可领, 退出本程序！')
                    sys.exit()
                for prizeinfo in prizeListRecord[:1]:
                    if inviteSuccNum >= prizeinfo[1]:
                        ...
                        if receive_result == 0:
                            ...
                            print(f'⛈⛈ 领取已经领取过其他奖励或未达到领取标准建议手动领取！')
                        else:
                            print(f'💥💥 领取奖励失败')
                    time.sleep(1.5)
                if inviteSuccNum >= prizeListRecord[0][1]:
                    print("奖励已领完")
                    sys.exit()
