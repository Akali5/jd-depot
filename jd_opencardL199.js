...
cron:25 1,3 22-31,1-6 7,8 *
============Quantumultx===============
[task_local]
#7.22-8.6 超燃好物 七夕献礼
25 1,3 22-31,1-6 7,8 * jd_opencardL199.js, tag=7.22-8.6 超燃好物 七夕献礼, enabled=true
...
!(async () => {
    ...
    // authorCodeList = await getAuthorCodeList('https://gitee.com/===31===/Code/raw/master/lzdz1.json')
